...
import { loadLandslide } from './landslide';
...
const planeMaterial1 = new THREE.MeshStandardMaterial({
  color: 0x22B14C,  // Green color
  transparent: true,  // Enable transparency
  opacity: 0.5  // Set opacity to 50% (0 = fully transparent, 1 = fully opaque)
});
...
gltfLoader.load('../../models/earthquake/mixed46.glb', (gltf) => {
  ...
  playerBody = new CANNON.Body({
    mass: 1, // Player mass
    position: new CANNON.Vec3(400, 0, 0), // Initial player position
